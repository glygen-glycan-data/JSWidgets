...
var msmsv = function () {
    ...
    // API functions in returning objects
    return {

        showUnlabelledSpectrum: function (container, tag, params) {
        ...
        showSpectrum: function (container, tag, path, tolerance, width=1000, height=300){
